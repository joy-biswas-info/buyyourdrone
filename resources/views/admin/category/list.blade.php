                ...
                <table class="table table-hover text-nowrap">
                    <thead>
                        <tr>
                            ...
                            <th>
                                <a
                                    href="{{ route('categories.index', ['sort' => 'id', 'direction' => $sort === 'id' ? ($direction === 'asc' ? 'desc' : 'asc') : 'asc']) }}">
                                    ID
                                    @if ($sort === 'id')
                                        @if ($direction === 'asc')
                            ...
                            <th>
                                <a
                                    href="{{ route('categories.index', ['sort' => 'name', 'direction' => $sort === 'name' ? ($direction === 'asc' ? 'desc' : 'asc') : 'asc']) }}">
                                    Name
                                    @if ($sort === 'name')
                                        @if ($direction === 'asc')
                                            <i class="fas fa-sort-up"></i>
                            ...
                            @foreach ($data as $category)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a id="delete_category" onclick="deleteCategory({{ $category->id }})"
